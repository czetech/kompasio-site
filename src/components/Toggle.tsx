...
const Toggle = (props) => {
  ...
  return (
    <button onClick={handleClick} class="text-vibrant-blue flex items-center gap-x-2">
      <div class="relative pr-1 h-5 border-2 rounded-full duration-200 focus:outline-none flex items-center" classList={{"bg-current": props.checked, "w-13": props.note != null, "w-9": props.note == null}}>
        <div
